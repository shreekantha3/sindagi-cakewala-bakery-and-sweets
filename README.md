# Cakewala Bakery and Sweets — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-cakewala-bakery-and-sweets/
- **Repo:** `shreekantha3/sindagi-cakewala-bakery-and-sweets` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-cakewala-bakery-and-sweets/'` for GitHub Pages project-site hosting.
